...
class SignUpSecondActivity : AppCompatActivity(), View.OnClickListener, HTTPConnectionListener {
    ...
    // TODO: opponentCodeED 값이 없으면 에러 발생 -> 고치기
            ...
            CHECK_CONNECTE_COMPLETED -> {
                ...
                when (responseData["respondData"].toString()) {
                    "false" -> {
                        ...
                        onSignUpSuccess(this, coupleColumnID)
                    }
                }
            }
            CHECK_CONNECTION -> {
    ...
    private fun failedDialog(message: String) {
        ...
        alertDialog.show(supportFragmentManager, "FailedDialog")
    }
    ...
    private val connection: ServiceConnection = object : ServiceConnection {
        override fun onServiceConnected(name: ComponentName, service: IBinder) {
            ...
            httpConnectionService.setOnHttpRespondListener(this@SignUpSecondActivity)
            getInviteCode()
        }
